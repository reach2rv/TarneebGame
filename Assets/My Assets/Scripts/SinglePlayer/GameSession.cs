...
namespace thecardsgame
{
    public class GameSession : MonoBehaviour
    {
        ...
        public GameSession()
        {
            ...
            currentBiddingStartPosition = PlayerPosition.West;
        ...
        public void Join(Player player, PlayerPosition position)
        {
            ...
            if (Status == GameSessionStatus.WaitingForPlayers)
            {
                ...
                //if (teams[TeamPosition.NorthSouth].IsTeam1Ready())
                //{
                //   // Status = GameSessionStatus.Bidding;
                //}
            }
            else
            {
                ...
                // && teams[TeamPosition.EastWest].IsReady()
            }
        }
        ...
        {
            return bots.Countcards();
        }
        public void PlaceBid(Bid bid)
        {

            if (Status == GameSessionStatus.Bidding && bidding.IsClosed == false)
            {
                //if (player.Name == "smart")
                //    bots.placehigher_card();
        ...
        //TODO: Photon Network
        public void PlaceCard(Player player, Cards card)
        {
        ...
        public Cards RoboCard()
        {
            return bots.placehigher_card();
        }
        /// <summary>
